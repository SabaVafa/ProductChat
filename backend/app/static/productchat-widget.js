...
(function () {
  ...
  *{ box-sizing:border-box; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; }\
  ...
  .chip{ font-size:12px; padding:6px 11px; background:#e3f0ef; border:1px solid #cfe6e4; border-radius:999px; cursor:pointer; color:#015253; font-weight:500; text-align:left; transition:all .14s; }\
  .chip:hover{ background:#d3e8e5; border-color:#9fccc8; color:#013f40; }\
