...
(function () {
  ...
  *{ box-sizing:border-box; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif; }\
  ...
  .empty .hero{ display:flex; align-items:center; justify-content:center; width:58px; height:58px; border-radius:19px; color:#015253; background:#e3f0ef; box-shadow:0 4px 12px -6px rgba(1,44,45,.16); margin:0 auto 14px; animation:pchero 3.6s ease-in-out infinite; }\
