...
def understand_query(
    ...
    system = (
        ...
        "shopper's PRIMARY product type. If the request combines a product with a feature "
        "(e.g. 'mailbox with a doorbell'), choose the categories of the PRODUCT (mailbox), NOT "
        "the feature. Use [] only if the product type is genuinely unclear.\n"
